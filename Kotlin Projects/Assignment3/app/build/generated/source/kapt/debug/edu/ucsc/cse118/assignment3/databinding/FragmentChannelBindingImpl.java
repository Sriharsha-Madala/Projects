...
public class FragmentChannelBindingImpl extends FragmentChannelBinding  {
    ...
    public FragmentChannelBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private FragmentChannelBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.channelFragment == variableId) {
            setChannelFragment((edu.ucsc.cse118.assignment3.ui.channels.ChannelsFragment) variable);
        }
    ...
    public void setChannelFragment(@Nullable edu.ucsc.cse118.assignment3.ui.channels.ChannelsFragment ChannelFragment) {
