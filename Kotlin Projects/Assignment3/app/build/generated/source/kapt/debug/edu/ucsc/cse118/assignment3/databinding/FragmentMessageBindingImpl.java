...
public class FragmentMessageBindingImpl extends FragmentMessageBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.channels, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.messageFragment == variableId) {
            setMessageFragment((edu.ucsc.cse118.assignment3.ui.MessageFragment) variable);
        }
    ...
    public void setMessageFragment(@Nullable edu.ucsc.cse118.assignment3.ui.MessageFragment MessageFragment) {
